...
&define test21(fc,p1,p2,r1) \
    ...
    DISPLAY SFMT("%6 %1(%2,%3)=\"%4\".  Expected Result=%5",#fc,#p1,#p2,rs1,#r1, IIF(rs1=r1,"PASS","FAIL"))

&define test31(fc,p1,p2,p3,r1) \
    CALL fc(p1,p2,p3) RETURNING rs1 \
    DISPLAY SFMT("%7 %1(%2,%3,%4)=\"%5\".  Expected Result=%6",#fc,#p1,#p2,#p3,rs1,#r1, IIF(rs1=r1,"PASS","FAIL"))
